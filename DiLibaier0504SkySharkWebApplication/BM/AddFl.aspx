...
<table>
    ...
    <tr>
        ...
        <td class="auto-style1">
            <asp:RequiredFieldValidator runat="server" ErrorMessage="Flight NumberRequired" ControlToValidate="txtFlightNumber"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
            <asp:TextBox ID="txtBusiFare" runat="server"></asp:TextBox></td>
        <td class="auto-style1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtBusiFare" ErrorMessage="Business Class Fares Required"></asp:RequiredFieldValidator>
         </td>
    </tr>
     <tr>
        <td></td>
